          ...
          <div className="text-center">
            ...
            >
              <div className="relative w-24 h-24 glass-card rounded-2xl flex items-center justify-center border border-primary-500/50 neon-glow animate-float">
                <Users className="text-primary-400" size={48} />
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 glass-effect rounded-full border border-primary-500/30">
              ...
              <span className="text-sm font-medium text-gray-300">Meet The Team</span>
            ...
            <p className="text-lg md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Meet the <span className="text-primary-400 font-semibold">passionate innovators</span> behind Perfionix AI who are dedicated to making 
              Artificial Intelligence <span className="text-accent-400 font-semibold">accessible, impactful, and ethical</span> for every sector.
            </p>
          </div>
        </motion.div>
      </div>
