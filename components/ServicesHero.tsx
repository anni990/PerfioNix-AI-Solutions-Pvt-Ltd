        ...
        >
          ...
          >
            <div className="relative w-24 h-24 glass-card rounded-2xl flex items-center justify-center border border-primary-500/50 neon-glow animate-float">
              <Cpu className="text-primary-400" size={48} />
          ...
          {/* Description */}
          <p className="text-lg md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
            Perfionix AI offers <span className="text-primary-400 font-semibold">end-to-end AI strategy</span> and implementation services that align with your organization's goals. 
            From roadmap design to deployment, we ensure your <span className="text-accent-400 font-semibold">AI transformation journey</span> is smooth and successful.
          </p>
        </motion.div>
      </div>
    </section>
